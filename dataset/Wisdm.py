...
class Wisdm(BaseDataset_new):
    def __init__(self, root, mode, windowlen,transform=None, autoencoderType = None):
        self.root = root
        self.mode = mode
        ...
        self.path_test_o_x = self.root + 'data_initial_step_scenario_1_x_test_windowLen_' + str(windowlen)+'.npy'
        self.path_test_o_y = self.root + 'data_initial_step_scenario_1_y_test_windowLen_' + str(windowlen)+'.npy'
        ...
        self.path_test_n_1_x = self.root + 'data_increment_step_scenario_1_x_test_windowLen_' + str(windowlen)+'.npy'
        self.path_test_n_1_y = self.root + 'data_increment_step_scenario_1_y_test_windowLen_' + str(windowlen)+'.npy'
