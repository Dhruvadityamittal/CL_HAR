...
if __name__ == '__main__':
    ...
    acc_o_base, f1_o_base, acc_n, f1_n, _, _ = get_accuracy_old_new(model, dlod_test_0, nb_classes, nb_classes, trained_prototypes_dict)
    ...
    acc_o, f1_o, acc_n, f1_n, _, _ = get_accuracy_old_new(model, dlod_test, nb_classes, nb_classes_now, trained_prototypes_dict)
    ...
    dlod_tr_only_new = torch.utils.data.DataLoader(dset_tr_only_new, batch_size=100, shuffle=True, num_workers=args.nb_workers)
    ...
    pth_rst_exp = 'Saved_Models/Incremental/Edison/' + args.dataset + '/' #+ args.model + '_sp_' + str(args.use_split_modlue) + '_gm_' + str(args.use_GM_clustering) + '_' + args.exp
    step = 2
    with open('{}{}_{}_BestEpoch__model_last_windowlen_{}_sz_embedding_{}_step_{}.json'.format(pth_rst_exp, 
                                                                                                args.dataset,
                                                                                                args.model,window_len,
